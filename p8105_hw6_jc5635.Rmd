...
(Adapted solution for Problem 1 is included below.)

```{r weather_tidy, cache = TRUE}
...
cities_log_reg %>% 
  ...
  labs(title = "Estimated adjusted odds ratios and confidence intervals for solved homicides, male versus female victims, by city",
       x = "City",
...
```{r bw_plot_resid}
modelr::add_residuals(birthweights, mod_a)
modelr::add_predictions(birthweights, mod_a)
```
